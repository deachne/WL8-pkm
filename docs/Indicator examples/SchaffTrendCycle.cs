...
namespace WealthLab.TASC
{
    public class SchaffTrendCycle : IndicatorBase
    {
        ...
        //static method
        public static SchaffTrendCycle Series(TimeSeries source, int tcLength, int macdPeriod1, int macdPeriod2)
        {
            string key = CacheKey("SchaffTrendCycle", tcLength, macdPeriod1, macdPeriod2);
            if (source.Cache.ContainsKey(key))
                return (SchaffTrendCycle)source.Cache[key];
            SchaffTrendCycle stc = new SchaffTrendCycle(source, tcLength, macdPeriod1, macdPeriod2);
            source.Cache[key] = stc;
            return stc;
        }
        ...
        protected override void GenerateParameters()
        {
            ...
            AddParameter("TC Length", ParameterType.Int32, 10);
            AddParameter("MACD Period1", ParameterType.Int32, 23);
            AddParameter("MACD Period2", ParameterType.Int32, 50);
        }
        ...
        public override WLColor DefaultColor => WLColor.Gold;

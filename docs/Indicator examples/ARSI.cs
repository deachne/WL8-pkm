...
namespace WealthLab.TASC
{
    public class ARSI : IndicatorBase
    {
        ...
        //static method
        public static ARSI Series(TimeSeries source, int period)
        {
            string key = CacheKey("ARSI", period);
            if (source.Cache.ContainsKey(key))
                return (ARSI)source.Cache[key];
            ARSI arsi = new ARSI(source, period);
            source.Cache[key] = arsi;
            return arsi;
        }
        ...
        public override void Populate()
        {
            ...
            */
            ...
            //Save final values for partial-bar calculation
            //_upMove = UpMove;
            //_dnMove = DnMove;
        }
